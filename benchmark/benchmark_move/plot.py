...
from benchmark_move.config import PlotParameters
from benchmark_move.aggregate import LogAggregator
    ...
    def plot(cls, params_dict):
        ...
        for f in params.faults:
            for n in params.nodes:
                # print(PathMaker.agg_file('robustness', f, n, 'x', tx_size, 'any'))
